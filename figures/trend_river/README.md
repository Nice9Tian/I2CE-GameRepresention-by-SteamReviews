...
ε=0.05, pruning 0.023, anchor marks every 3 years, anchor-title font 40 px,
lane labels 45 px), renders it in headless Chrome at device scale factor 4,
and writes `fig6_content_river_ice.png` (9,476 × 4,088) plus
