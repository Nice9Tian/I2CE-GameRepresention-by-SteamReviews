...
*Table A13: The single-source reading — each of the ten anchor packs is scored on its own and the scores are averaged (five-fold mean ± std, testset queries (ts), 4,096-sentence anchors). This is the protocol of every table in the body, reproduced here for comparison with Table A14.*
